...
public class ApplicationLogger {
	...
	private String getClassName() {
		String className = Constants.BLANK.getValue();
		try {
	...
	private String getMethodName() {
		String methodName = Constants.BLANK.getValue();
		try {
	...
	public void entry() {
		logger.info(getBaseMessage(Constants.ENTRY.getValue()));
	}

	public void exit() {
		logger.info(getBaseMessage(Constants.EXIT.getValue()));
	}
